...
export type ControlMethod = "approval.resolve" | "changeset.apply" | "changeset.commit" | "changeset.prepare" | "changeset.rollback" | "core.health" | "core.initialize" | "events.subscribe" | "goal.create" | "plan.freeze" | "run.cancel" | "run.fork" | "run.pause" | "run.resume" | "run.retry" | "run.start" | "run.steer" | "task.delegate" | "worktree.create" | "worktree.integrate";
